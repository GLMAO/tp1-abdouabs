...
/**
 * Version améliorée utilisant PropertyChangeSupport
...
public class DummyTimeServiceImpl implements TimerService {
    ...
    // Utilisation de PropertyChangeSupport pour gérer les listeners
    ...
    public void addTimeChangeListener(TimerChangeListener pl) {
        // PropertyChangeSupport gère les listeners de manière thread-safe
        support.addPropertyChangeListener((PropertyChangeListener) pl);
    }

    @Override
    public void removeTimeChangeListener(TimerChangeListener pl) {
        // PropertyChangeSupport gère la suppression de manière thread-safe
        support.removePropertyChangeListener((PropertyChangeListener) pl);
    }
    ...
    public void setDixiemeDeSeconde(int newDixiemeDeSeconde) {
        ...
        // PropertyChangeSupport notifie tous les listeners
